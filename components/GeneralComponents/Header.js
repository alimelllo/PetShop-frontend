  ...
  return (
    <header
      className={`flex flex-row w-full ${asPath !== "/" && ` ${themeState === 'dark' ? "bg-[#191919] boxShadow2x" :"bg-white shadow-2xl"}`
        ...
        } transition-all duration-300 fixed top-[-0.25%] justify-between text-white z-50 font-[Bhoma] md:py-2  ${themeState === 'dark' ? "md:bg-[#191919] boxShadow2x" :"bg-transparent md:bg-[white] md:shadow-2xl"} `}
    >
