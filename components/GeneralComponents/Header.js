...
const Header  = ()  => {
    return (
     ...
     <div className="w-4/12 flex flex-row justify-center  text-[#676767] text-center pt-3 text-[1.5rem] md:text-[1rem]">
     ...
     <div className="w-3/12 flex flex-row py-3 justify-end pr-5 text-center text-[#676767] text-[1.25rem]  ">
       ...
       <Link href='/CreateAcount'><p className='text-center md:hidden text-[#676767] pt-3 pr-[2rem] text-[1.25rem] cursor-pointer transition-all duration-200 hover:scale-105 hover:text-[#1a1a1a] hover:font-[600]'>ثبت نام </p></Link>
