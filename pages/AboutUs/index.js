          ...
          <div className="contactCard mx-auto boxShadow2x">
            <div className="contactHeader ">
              ...
              <div>
                ...
                <p className="name">Feed US</p>
              </div>
            </div>

            <p className="message font-[bhoma] text-[1.25rem] scale-90 mt-10 flex flex-wrap">
              در حال حاضر سفارش فقط از طریق وب سایت امکان پذیر است
            </p>
          </div>
        </div>
