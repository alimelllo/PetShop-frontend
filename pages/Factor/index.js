        ...
        >
          <div className="paper pt-[1rem] md:pt-0">
            ...
            <div className="flex font-[bhoma] flex-row justify-center px-2 py-2 my-3 md:my-1 items-center ">
              <p onClick={() => SetPaymentType("ONLINE")} className={`${paymentType === "ONLINE" ? 'opactiy-[1] scale-105 boxShadow4x' : 'opacity-[0.4] scale-100'} cursor-pointer transition-all duration-200 w-6/12 text-[1.25rem] text-[white]  text-center p-1 md:p-1 rounded-l-[10px]  bg-[#823edb]`}>پرداخت آنلاین</p>
              <p onClick={() => SetPaymentType("ONSITE")} className={`${paymentType === "ONSITE" ? 'opactiy-[1] scale-105 boxShadow4x' : 'opacity-[0.4] scale-100'} cursor-pointer transition-all duration-200 w-6/12 text-[1.25rem] text-[white]  text-center p-1 md:p-1 rounded-r-[10px]  bg-[#3e56db]`}>درب منزل</p>
            </div>
            ...
            <div className="border-t-[3px] border-dashed border-t-[#807777] flex flex-row justify-between px-2 py-2 my-3 md:my-1 items-center">
              ...
              <p className="text-[1rem] text-[#00773d] font-bold text-right">2,455,000 T</p>
            </div>
            <div className="flex">
              <input
